...
forward-corridor safety controller가 도로 중심선·도로 폭·밝은 위험 영역 신호를 사용해
...
상호 배타적으로 선택하며, 안전한 직선 통로에서의 기본 순항 목표와 가속 상한은 각각
`68`과 `0.16`으로 설정합니다. 작은 픽셀 양자화로 생기는 회전 전 흔들림은 직선 deadband에
