> **Historical snapshot, archived 2026-09-23.** This pre-migration README mixed an
> upstream template, legacy implementation notes, and dated experiment history. It
> is retained for provenance only. Use the root `README.md`, `docs/competition/`,
> and `docs/context/current-state.md` for current guidance.
